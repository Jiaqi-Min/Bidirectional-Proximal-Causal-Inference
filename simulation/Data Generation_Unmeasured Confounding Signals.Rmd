---
title: "Data Generation for Unmeasured Confounding Signals"
author: "Jiaqi Min"
date: "2025-05-22"
...
saveRDS(all_iterations, file = "iterations_200_strength.rds")

cat("\nSimulation completed. Results saved to 'iterations_200_strength.rds'\n")
```