...
generate_data <- function(N, scenario, alpha_u, gamma_u, n_time = 5000) {
...
alpha_gamma_combinations <- mapply(
  function(a, g) c(alpha_u = a, gamma_u = g),
...
stopCluster(cluster)
saveRDS(all_iterations, file = "Data/Sim_Data_Confounding.rds")